...
from gmn.graph_construct.net_makers import make_cnn_1d
...
class CNN1DArchHyperparams(ArchHyperparams):
    hidden_dim: int
    conv_layers: int
    fc_layers: int
    norm: str
...
@register_family
class CNN1DFamily(ModelFamily):
    family_name = "cnn1d"

    def sample_arch_hyperparams(self, rng: random.Random) -> CNN1DArchHyperparams:
        return CNN1DArchHyperparams(
    ...
    def build_model(self, hparams: CNN1DArchHyperparams) -> nn.Sequential:
        return make_cnn_1d(
